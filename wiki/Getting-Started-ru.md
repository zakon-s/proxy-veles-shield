...
Эта страница проведёт вас от свежей установки до рабочего соединения. Предполагается, что Veles Proxy уже установлен (установку пакетов см. в [README](../../blob/master/README_ru.md)).

> Всё ниже делается в веб-интерфейсе LuCI: **Сервисы → Veles Proxy**.
...
На странице **Настройки клиента** задайте **Основной узел** = добавленный узел — или выберите **URLTest**, чтобы Veles Proxy автоматически выбирал самый быстрый доступный узел и переключался при сбоях.
